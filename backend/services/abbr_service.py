...
from langchain_openai import (
    AzureChatOpenAI,
)  # Import AzureChatOpenAI for Azure OpenAI integration
...
class AbbrService:
    ...
    def _get_std_service(self, embedding_options: dict) -> StdService:
        ...
        try:
            return StdService(
                ...
                collection_name=embedding_options.get(
    ...
    def simple_ollama_expansion(self, text: str, llm_options: dict) -> Dict:
        ...
        return {"input": text, "expanded_text": expanded_text, "method": "simple_llm"}

    def llm_rank_query_db(
        self, text: str, context: str, llm_options: dict, embedding_options: dict
    ) -> Dict:
        """
        ...
        try:
            ...
            expand_prompt = ChatPromptTemplate.from_messages(
                [
                    (
                        "system",
                        "Given the medical abbreviation and its context, provide the most likely expansion based on common medical usage.",
                    ),
            ...
            expansion_text = (
                expansion_result.content
                if hasattr(expansion_result, "content")
                else str(expansion_result)
            )
